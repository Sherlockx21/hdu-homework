...
import com.trainsystem.Mapper.StationMapper;
import com.trainsystem.Mapper.TrainMapper;
import com.trainsystem.controller.TrainController;
...
public class TrainServiceImpl implements TrainService {
    ...
    public Train getTrainInfoById(String tid) throws Exception {
        Train train = trainMapper.getTrainInfoById(tid);// 根据编号获取车辆信息
